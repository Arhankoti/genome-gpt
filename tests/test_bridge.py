...
def _make_mock_model():
    m = MagicMock()
    m.score.return_value = {"mean_logprob": -1.4, "perplexity": 4.0, "bits_per_bp": 2.0, "n_scored": 8}
    m.generate.return_value = "ACGTACGT"
    m.variant_effect.return_value = {"llr": -0.5, "ref_base": "A", "alt_base": "T", "position": 0, "interpretation": "more disruptive"}
